...
const Orb = ({
  ...
  <motion.div
    ...
    animate={{
      ...
      scale: [0.3, 1, 1.3, 1],
      x: [scatterX, 0, 20, -10, 0],
      y: [scatterY, 0, -15, 10, 0],
    }}
    transition={{
      duration: duration,
      delay,
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 2, delay: delay + 0.8, repeat: Infinity, ease: "easeInOut" }}
      />
    </motion.div>
  );
};
    ...
    <div className="absolute inset-0 overflow-hidden">
      {lines.map((line) => (
        <motion.div
          ...
          animate={{ opacity: [0, 0.3, 0.6, 0.3], scaleX: 1, scaleY: 1 }}
          transition={{
            duration: 1.5,
            delay: line.id * 0.1,
            ease: [0.22, 1, 0.36, 1],
...
const HexNode = ({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: [0, 0.6, 0.4], scale: [0, 1.1, 1], rotate: 0 }}
